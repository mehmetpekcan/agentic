---
name: tdd
description: Implement code using Test-Driven Development — tests as a design tool, not a coverage exercise. Use when implementing any feature or bug fix that requires writing production code.
---
