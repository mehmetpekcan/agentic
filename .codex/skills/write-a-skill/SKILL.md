...
name: write-a-skill
description: >-
  Guides creation of agent skills with frontmatter, progressive disclosure,
  optional scripts, and split reference files. Use when writing or authoring
  skills, creating SKILL.md, scaffolding .rulesync/skills, or defining skill
  descriptions and trigger phrases.
---
# Writing Skills
